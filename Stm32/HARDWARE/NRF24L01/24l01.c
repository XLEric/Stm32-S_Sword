...
u8 NRF24L01_Check(void)
{
	...
	u8 i;
	SPIx_SetSpeed(SPI_SPEED_128); //spi速度为9Mhz（24L01的最大SPI时钟为10Mhz）   	 
...
//}		  
//u8 READ_MPU9250_MAG(uchar reg)
//{ 
//	u8 reg_val=0;
//    NRF24L01_Write_Reg(0x37,0x02);//turn on Bypass Mode 
//   delay_ms(10);	
//   NRF24L01_Write_Reg(0x0A,0x11);
//				
//   delay_ms(10);	
//   	 
